...
export default {
  ...
  sponsorDialog: {
    ...
    cometAffiliate: {
      title: "🎁 Αποκτήστε το δωρεάν σας <0>PERPLEXITY PRO</0>!",
      description:
        "Εγγραφόμενοι με αυτόν τον σύνδεσμο συνεργάτη, θα λάβετε μια δωρεάν συνδρομή <0>PERPLEXITY PRO</0> για τον πρώτο μήνα και παράλληλα θα συνεισφέρετε άμεσα στην ανάπτυξη του Complexity.",
