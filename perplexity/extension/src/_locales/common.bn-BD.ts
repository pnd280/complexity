...
export default {
  ...
  sponsorDialog: {
    ...
    cometAffiliate: {
      title: "🎁 আপনার বিনামূল্যে <0>PERPLEXITY PRO</0> পান!",
      description:
        "এই affiliate লিংকের মাধ্যমে সাইন আপ করে, আপনি প্রথম মাসের জন্য একটি বিনামূল্যে <0>PERPLEXITY PRO</0> সাবস্ক্রিপশন পাবেন এবং এর মধ্যে সরাসরি Complexity এর উন্নয়নে অবদান রাখবেন।",
