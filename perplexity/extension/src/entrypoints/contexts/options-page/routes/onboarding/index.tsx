...
import BasePermissions from "@/entrypoints/contexts/options-page/routes/onboarding/BasePermissions";
import CometPatch from "@/entrypoints/contexts/options-page/routes/onboarding/CometPatch";
import ExtensionIconAction from "@/entrypoints/contexts/options-page/routes/onboarding/ExtensionIconAction";
import MultiLingualSupport from "@/entrypoints/contexts/options-page/routes/onboarding/MultiLingualSupport";
import PluginEcosystem from "@/entrypoints/contexts/options-page/routes/onboarding/PluginEcosystem";
import SupportChannels from "@/entrypoints/contexts/options-page/routes/onboarding/SupportChannels";
import {
  isCometBrowserSync,
  isCsInjectableSync,
} from "@/entrypoints/utils/comet";
