...
import { useOptionsPageSidebarStore } from "@/entrypoints/contexts/options-page/components/sidebar/store";
import Version from "@/entrypoints/contexts/options-page/components/sidebar/Version";
import SidebarUpdateAnnouncer from "@/entrypoints/contexts/options-page/components/SidebarUpdateAnnouncer";
import SponsorDialogWrapper from "@/entrypoints/contexts/options-page/components/SponsorDialogWrapper";
      ...
      <div className="x:sticky x:bottom-0 x:z-10 x:flex x:shrink-0 x:flex-col x:gap-4 x:bg-background x:p-4">
        ...
        <SponsorDialogWrapper>
          <div
            role="button"
            tabIndex={0}
            className="x:group x:relative x:w-full x:cursor-pointer x:rounded-xl x:border x:border-border/50 x:bg-secondary x:p-4 x:text-sm x:text-foreground x:shadow-lg x:transition-all x:hover:scale-101 x:hover:text-foreground x:md:text-pretty"
          >
            <Trans
