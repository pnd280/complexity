import type { AnchorSlice } from "@/entrypoints/contexts/content-scripts/core-plugins/slash-command/store/slices/anchor";
import { createTextboxAdapter } from "@/entrypoints/contexts/content-scripts/core-plugins/slash-command/textbox-adapter";
