...
import { locationWaits } from "@/entrypoints/contexts/content-scripts/core-plugins/spa-router/location-waits";
import { SpaRouterService } from "@/entrypoints/contexts/content-scripts/core-plugins/spa-router/service/service-init";
import {
  spaRouterStore,
  type SpaRouterStore,
} from "@/entrypoints/contexts/content-scripts/core-plugins/spa-router/store";
