...
import { hasPermissions } from "@/entrypoints/services/extension-api-wrappers/permissions/utils";
import { instantCssCoordinator } from "@/entrypoints/services/features/instant-css/coordinator";
import type {
  InstantCss,
  InstantCssSettings,
} from "@/entrypoints/services/features/instant-css/types";
import { getProcessedCssEntries } from "@/entrypoints/services/features/instant-css/utils";
import { invariant, isBackgroundScript } from "@/utils/misc/utils";

export { backgroundProxyServiceName } from "@/entrypoints/services/features/instant-css/injector/constants";
