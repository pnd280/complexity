...
import type { slashCommandMenuStore } from "@/plugins/__core__/slash-command/store";
import type { AnchorSlice } from "@/plugins/__core__/slash-command/store/slices/anchor";
import type { PagesStackSlice } from "@/plugins/__core__/slash-command/store/slices/pages";
import type { StatesSlice } from "@/plugins/__core__/slash-command/store/slices/states";
