...
import { getBetterCodeBlockOptions } from "@/plugins/_thread/better-code-blocks/utils";
import ArtifactSimpleModeRenderButton from "@/plugins/_thread/better-code-blocks/variants/base/header-buttons/ArtifactSimpleModeRenderButton";
import { ExpandCollapseButton } from "@/plugins/_thread/better-code-blocks/variants/base/header-buttons/ExpandCollapseButton";
import { WrapToggleButton } from "@/plugins/_thread/better-code-blocks/variants/base/header-buttons/WrapToggleButton";
...
export default function BaseCodeBlockWrapperHeader() {
  ...
  const globalSettings = PluginsSettingSnapshotsService.getPluginSnapshot(
    ...
    >
      <div className="x:flex x:items-center x:gap-2">
        ...
        {!isInFlight && placeholderText?.idle && (
          <div className="x:flex x:items-center x:gap-2">
            <Separator orientation="vertical" className="x:h-4 x:w-0.5" />
